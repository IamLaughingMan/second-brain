...
para: resource
domain: obsidian-ai
title: "jacksteamdev/obsidian-mcp-tools: Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client"
url: "https://github.com/jacksteamdev/obsidian-mcp-tools"
status: active
created: 2026-06-26
updated: 2026-06-26
summary: "MCP server plugin (Obsidian 內 run)：semantic search vault + custom Templater prompts；Pattern C 嘅 enhancement layer；MCP protocol-agnostic 跨 client (Claude/Cursor/Codex)"
tags:
  - bookmark
  - obsidian
  - ai
...
> MCP server plugin (Obsidian 內 run)：semantic search vault + custom Templater prompts；Pattern C 嘅 enhancement layer；MCP protocol-agnostic 跨 client (Claude/Cursor/Codex)
...
**Before contributing, please read our [Contributing Guidelines](https://github.com/jacksteamdev/obsidian-mcp-tools/blob/main/CONTRIBUTING.md) including our community standards and behavioral expectations.**
...
**Please read our [Contributing Guidelines](https://github.com/jacksteamdev/obsidian-mcp-tools/blob/main/CONTRIBUTING.md) before posting.** We maintain high community standards and have zero tolerance for toxic behavior.
...
[^2]: For a list of available MCP Clients, see [MCP Example Clients](https://modelcontextprotocol.io/clients)

[^3]: For information about Claude data privacy and security, see [Claude AI's data usage policy](https://support.anthropic.com/en/articles/8325621-i-would-like-to-input-sensitive-data-into-free-claude-ai-or-claude-pro-who-can-view-my-conversations)
