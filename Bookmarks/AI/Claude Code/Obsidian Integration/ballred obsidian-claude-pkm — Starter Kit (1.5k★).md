...
para: resource
domain: obsidian-ai
title: "ballred/obsidian-claude-pkm: A complete starter kit for an Obsidian + Claude Code PKM system"
url: "https://github.com/ballred/obsidian-claude-pkm"
status: active
created: 2026-06-26
updated: 2026-06-26
summary: "Pattern A 代表 starter kit (1.5k★)：4 agents + 10 skills + auto-commit hook + Productivity Coach output style；3-year vision → daily 系統；ballred 嘅 SETUP_GUIDE.md 詳細"
tags:
  - bookmark
  - obsidian
  - ai
...
# ballred/obsidian-claude-pkm: A complete starter kit for an Obsidian + Claude Code PKM system

> [!info] Bookmark · obsidian-ai domain · Claude-found
> Pattern A 代表 starter kit (1.5k★)：4 agents + 10 skills + auto-commit hook + Productivity Coach output style；3-year vision → daily 系統；ballred 嘅 SETUP_GUIDE.md 詳細
...
- **[Setup Guide](https://github.com/ballred/obsidian-claude-pkm/blob/main/docs/SETUP_GUIDE.md)** — Detailed installation instructions
- **[Customization](https://github.com/ballred/obsidian-claude-pkm/blob/main/docs/CUSTOMIZATION.md)** — Make it yours
- **[Workflow Examples](https://github.com/ballred/obsidian-claude-pkm/blob/main/docs/WORKFLOW_EXAMPLES.md)** — Daily routines and best practices
- **[Troubleshooting](https://github.com/ballred/obsidian-claude-pkm/blob/main/docs/TROUBLESHOOTING.md)** — Common issues and solutions
- **[Contributing](https://github.com/ballred/obsidian-claude-pkm/blob/main/CONTRIBUTING.md)** — How to help

## Contributing

We welcome contributions! See [CONTRIBUTING.md](https://github.com/ballred/obsidian-claude-pkm/blob/main/CONTRIBUTING.md) for guidelines. Good first issues are labeled — check the [issues page](https://github.com/ballred/obsidian-claude-pkm/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
