...
- **混合結構**：`wiki/` 根層平放 meta（`index/log/hot/overview`；**overview 2026-06-17 起由 index 拆出**，align Karpathy 一手）與跨領域方法頁；**領域內容歸入領域資料夾**（如 `wiki/Health/Oral/Periodontal Disease/`），鏡射 MOC hub 階層。檢索仍靠 `index.md` + `[[wikilink]]`，資料夾只是人類瀏覽的次要動線。
