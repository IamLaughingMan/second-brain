...
本 vault 除咗 `CLAUDE.md`（Claude Code 專讀），仲有 root **`AGENTS.md`**（vendor-neutral，俾**其他** AI agent 如 Codex／Gemini／Cursor 自動讀）。`AGENTS.md` 指引其他 AI:① 讀 `CLAUDE.md` 規矩 ② 去 **`Meta/ai-comms/ai-comms.md`** 溝通頻道讀/留言 ③ 回應時報上自己係乜 AI。
